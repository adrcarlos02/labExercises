...
import maternalHealthImage from '../assets/BannerMaternalHealth.png';

const BannerMaternalHealth = () => (
  <Link to="/doctors/Gynecologist" className="relative w-full h-0 pb-[75%] rounded-lg shadow-lg overflow-hidden group"> {/* Wrap in Link */}
    <img 
      src={maternalHealthImage} 
      alt="Maternal Health" 
    ...
    <div className="absolute bottom-0 left-0 w-full h-full flex flex-col items-center justify-center bg-gradient-to-b from-transparent to-gray-800 opacity-75 p-5 md:p-7 lg:p-9">
      ...
      <div className="flex justify-center items-center mt-0">
        <p className="text-white text-sm md:text-base lg:text-lg text-center hidden md:block opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100"> {/* Appear on hover */}
          Specialised in gynaecological care and maternal health. Our maternal health services encompass preconception counselling, prenatal care, and postpartum support. We prioritise the health of both mother and baby, offering education and resources to navigate the journey of pregnancy and motherhood. Our compassionate team is here to address any concerns, ensuring a safe and healthy experience for every family.
        </p>
      </div>
    </div>
  </Link>
...
export default BannerMaternalHealth;